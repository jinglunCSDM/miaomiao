<template>
  <div id="detailContrainer" class="slide-enter-active">
		...
		<div id="content" class="contentDetail">
			...
			<div class="detail_player swiper-container" ref="detail_playing">
...
export default {
    ...
    mounted () {
        this.axios.get('/ajax/detailmovie?movieId='+ this.movieId).then(res=>{
            ...
            this.$nextTick(()=>{
                new Swiper(this.$refs.detail_playing, {
                    slidesPerView: 'auto',
                    freeMode: true,
                    freeModeSticky: true
                });
...
<style scoped>
#detailContrainer{ position: absolute; left: 0; top: 0; z-index: 99; width: 100%; min-height: 100%; background: white;}
